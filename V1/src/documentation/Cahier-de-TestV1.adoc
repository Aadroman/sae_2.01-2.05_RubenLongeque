...
|La fenêtre d'enregistrement d'un virement s'ouvre. +
L'opération s'enregistre dans las Base de Données et s'affiche sur la fenêtre. +
Le montant de l'oprération est positif. +
|Le compte ne doit pas être cloturer

|TestEnregistrerVirementNOK
|Le texte se met en rouge si une information est fausse. +
L'opération ne s'enregistre pas dans la Base de Données. +
|Le compte ne doit pas être cloturer
|===
